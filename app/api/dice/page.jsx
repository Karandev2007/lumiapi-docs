...
const DiceRoll = () => {
  return (
    <div className="max-w-7xl mx-auto p-8 bg-gray-900 text-white">
      ...
      {/* api info header */}
      <h2 className="text-3xl font-semibold mb-4">Dice Roll API</h2>
      <p className="text-lg mb-4">Roll a dice and get a random result.</p>
      
      {/* api endpoint description */}
      <h3 className="text-xl font-medium mb-2">endpoint:</h3>
      <pre className="bg-gray-800 p-4 rounded-lg">GET /v1/dice</pre>

      <h3 className="text-xl font-medium mt-4 mb-2">example request url:</h3>
      <pre className="bg-gray-800 p-4 rounded-lg">https://api.qeintech.in/v1/dice</pre>
